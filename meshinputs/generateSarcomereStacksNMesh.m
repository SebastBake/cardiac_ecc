...
ImageDir = ['/Users/vrajagopal/Documents/heart/data/schneider/tomographic_reconstructions/'];
stack_outDir = ['/Users/vrajagopal/Documents/heart/data/schneider/high-res-ryrsim-inputs/'];
mesh_outDir = ['/Users/vrajagopal/Documents/heart/meshing/cellSpecificPLC/schneider_tomo/Cell_schneider_tomo/'];
%read in ryr gaps image stack
imres = [0.035,0.035,0.035]; %need to change depending on the resolution of image on which we want to simulate RyRs; typically isometric voxels are used, so res is same in all directions.
sarclength = 0.9;
total_sarc_slices = round(sarclength/imres(3));

%% read in sarcolemma stack
slfile = [ImageDir 'SarcoBinaryTIFF/SarcoBinary_mod_lowres.tif'];
...
mffile = [ImageDir 'MyoBinaryTIFF/CombinedMyofibrils_asIndividuals_lowres.tif'];
...
mtfile = [ImageDir 'CombinedMitos_asgroups_lowres.tif'];
...
mMfile = [ImageDir 'CombinedBinaryTIFF/RyRGaps_lowres.tif'];
